...
#    if head.data%2 != 0:
#      if len(subpart) > 0:
#        origin_arr = origin_arr + list(reversed(subpart))
#        subpart = []
#      origin_arr.append(head.data)
#    else:
#      subpart.append(head.data)
#    
#    if head.next == None:
#      origin_arr = origin_arr + list(reversed(subpart))
#
#    head = head.next
#
#  return createLinkedList(origin_arr)
